...
export default function Project({
  ...
  return (
    ...
    >
      <section className="bg-gray-200 max-w-[42rem] border border-black/5 rounded-lg overflow-hidden relative sm:h-[20rem] hover:bg-gray-100 transition sm:group-even:pl-8 dark:text-white dark:bg-white/10 dark:hover:b-white/20 ">
